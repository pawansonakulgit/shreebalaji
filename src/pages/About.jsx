        ...
        <div className="container">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="relative mb-12">
              ...
              <div
                className="ml-auto mr-auto md:ml-0 md:mr-auto md:w-1/2 md:pr-8 mb-10"
                data-aos="fade-right"
              >
            ...
            <div className="relative mb-12">
              ...
              <div
                className="ml-auto mr-auto md:ml-auto md:mr-0 md:w-1/2 md:pl-8 mb-10"
                data-aos="fade-left"
              >
                <div className="p-4 bg-white rounded-lg shadow-md">
            ...
            <div className="relative">
              ...
              <div
                className="ml-auto mr-auto md:ml-0 md:mr-auto md:w-1/2 md:pr-8"
                data-aos="fade-right"
              >
                <div className="p-4 bg-white rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <img
                ...
                className="w-32 h-32 object-cover rounded-full mx-auto mb-4"
              />
              <h3 className="text-xl font-semibold mb-1">Priya Desai</h3>
