...
const Navbar2 = () => {
    ...
    const linkClass = "px-3 py-2 text-slate-700 hover:text-primary-600 transition-all duration-200"
        ...
        <header className={navClasses}>
            <div className="container flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center space-x-2">
                    <span className="text-2xl font-bold text-primary-600">Shree Balaji</span>
                    <span className="text-lg font-medium text-slate-700">Electronics</span>
                </Link>
                ...
                <div className="hidden md:flex items-center space-x-3">
                    <a href="tel:+919876543210" className="flex items-center px-4 py-2 font-medium text-white rounded-md bg-primary-600 hover:bg-primary-700 transition-all duration-300">
                        <HiPhone className="mr-2" />
                        <span>Call Now</span>
                    </a>
                    <a href="https://wa.me/919876543210?text=Hi%20Shree%20Balaji%20Electronics,%20I%20need%20TV%20repair%20service."
